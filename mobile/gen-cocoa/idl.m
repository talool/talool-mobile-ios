...
@interface add_args : NSObject <NSCoding> {
  Message * __msg;
...
@interface Add_result : NSObject <NSCoding> {
}
...
@interface get_args : NSObject <NSCoding> {
}
...
@interface Get_result : NSObject <NSCoding> {
