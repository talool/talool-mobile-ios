...
-(void) setMerchant:(ttMerchant *)merchant;
{
    ...
    [merchantLogo sd_setImageWithURL:[NSURL URLWithString:merchantLocation.logoUrl]
    ...
    if ([merchant.locations count]>1)
    {
        ...
        FAKFontAwesome *angleIcon = [FAKFontAwesome angleRightIconWithSize:10];
        NSMutableAttributedString *text = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@  %@", message, angleIcon.characterCode]];
        UIFont *fa = [angleIcon iconFont];
