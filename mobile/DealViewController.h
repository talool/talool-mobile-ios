...
@interface DealViewController : UIViewController<TaloolDealActionDelegate, FBFriendPickerDelegate, ABPeoplePickerNavigationControllerDelegate>
...
@property (nonatomic, retain) IBOutlet UIImageView *texture;
